...
//
// The rest of this directory is generated by orval from the api OpenAPI
// spec (`bun run generate:api`), which reads the spec from a running api
// instance. This endpoint — PATCH /api/v1/chats/{id} — isn't in the generated
// client yet. Once the API is regenerated against a api build that includes

...
export type listGroupsResponseError = (
    | listGroupsResponse401
    | listGroupsResponse500
) & {
    headers: Headers;
};

export type listGroupsResponse =
    | listGroupsResponseSuccess
    | listGroupsResponseError;
...
export type deleteGroupResponseError = (
...
export type updateGroupResponse =
    | updateGroupResponseSuccess
    | updateGroupResponseError;

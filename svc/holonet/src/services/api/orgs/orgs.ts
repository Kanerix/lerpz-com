...
export const getListOrgsQueryOptions = <TData = Awaited<ReturnType<typeof listOrgs>>, TError = ErrorType<ProblemSchema>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listOrgs>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useListOrgs<TData = Awaited<ReturnType<typeof listOrgs>>, TError = ErrorType<ProblemSchema>>(
...
export const getCreateOrgMutationOptions = <TError = ErrorType<ProblemSchema>,
 ...
 * @summary Create a new organization
 */
export const useCreateOrg = <TError = ErrorType<ProblemSchema>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createOrg>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
...
export const getGetOrgQueryOptions = <TData = Awaited<ReturnType<typeof getOrg>>, TError = ErrorType<ProblemSchema>>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getOrg>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetOrg<TData = Awaited<ReturnType<typeof getOrg>>, TError = ErrorType<ProblemSchema>>(
...
export const getDeleteOrgMutationOptions = <TError = ErrorType<ProblemSchema>,
 ...
 * @summary Delete a new organization
 */
export const useDeleteOrg = <TError = ErrorType<ProblemSchema>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteOrg>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getUpdateOrgMutationOptions = <TError = ErrorType<ProblemSchema>,
 ...
 * @summary Update a specific organization
 */
export const useUpdateOrg = <TError = ErrorType<ProblemSchema>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateOrg>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<

...
import { MdSmartToy, MdCheck, MdLoop, MdClose } from "react-icons/md";
...
export function ModelSelectorTrigger() {
  ...
  return (
    <Popover>
      ...
      <PopoverBackdrop />
      <PopoverPortal>
        <PopoverPositioner side="top" sideOffset={12} align="center" anchor={chatboxAnchor}>
            ...
            <div className="flex flex-col gap-3">
              {model.settings.map((setting) => (
                <ModelSettingRow
                  ...
                  setting={setting}
                  currentValue={
                    getModelSetting(model.value ?? undefined, setting.key) ??
                    setting.defaultValue ??
                    null
                  }
                  onChange={(value) => {
                    if (model.value) {
                      setModelSetting(model.value, setting.key, value);
                    }
                  }}
                />
              ))}

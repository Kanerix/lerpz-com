...
export const getTriggerFailureQueryOptions = <TData = Awaited<ReturnType<typeof triggerFailure>>, TError = ErrorType<HandlerErrorSchema>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof triggerFailure>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type TriggerFailureQueryError = ErrorType<HandlerErrorSchema>


export function useTriggerFailure<TData = Awaited<ReturnType<typeof triggerFailure>>, TError = ErrorType<HandlerErrorSchema>>(
...
export const getHealthCheckQueryOptions = <TData = Awaited<ReturnType<typeof healthCheck>>, TError = ErrorType<HandlerErrorSchema>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof healthCheck>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type HealthCheckQueryError = ErrorType<HandlerErrorSchema>


export function useHealthCheck<TData = Awaited<ReturnType<typeof healthCheck>>, TError = ErrorType<HandlerErrorSchema>>(

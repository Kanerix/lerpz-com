...
import type { HandlerErrorSchema, HealthCheck } from "../models";
...
>(options?: {
	query?: Partial<
		UseQueryOptions<Awaited<ReturnType<typeof triggerFailure>>, TError, TData>
	>;
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof triggerFailure>>> = ({
		signal,
	}) => triggerFailure({ signal, ...requestOptions });

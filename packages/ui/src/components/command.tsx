...
import { InputGroup, InputGroupAddon } from "@lerpz/ui/components/input-group";
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <MdCheck className="ml-auto opacity-0 group-has-[[data-slot=command-shortcut]]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  );
}

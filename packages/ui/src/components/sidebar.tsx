...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@lerpz/ui/components/sheet";
...
import { useIsMobile } from "@lerpz/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Cookie Store API is not universally supported; direct assignment is intentional for sidebar state persistence
